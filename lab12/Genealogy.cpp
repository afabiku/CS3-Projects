...
class MiddlePrinter: public NamePrinter {
public:
    void visit(Man *m) override {
        if (m->getFather() != nullptr) {
            cout << m->getFirstName() << " "
                 << m->getFather()->getFirstName() << " "
                 << m->getLastName() << endl;
        } else {
            cout << m->getFirstName() << " "
                 << m->getLastName() << endl;
    ...
    void visit(Woman *w) override {
      cout << w->getFirstName() << " ";
        if (w->getMother() != nullptr) {
            cout << w->getMother()->getFirstName() << " ";
        } 
        if(w->getFather() != nullptr) {
            cout << static_cast<Man *>(w->getFather())->getLastName();
        }else {
            cout << "Doe"; // Default last name
        }
        cout << endl;
    }
};
...
int main(){
   ...
   MiddlePrinter *mp = new MiddlePrinter;
